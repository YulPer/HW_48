...
public class StAX_Parser {
	public static void main(String[] args) throws Exception {
		...
		eventType = reader.next();
			...
			if (reader.getLocalName() == element_06) {System.out.println("Price: \t " + reader.getElementText());}
			if (reader.getLocalName() == element_05) {System.out.println("Number of deals: " + reader.getAttributeValue(0));}
			if (reader.getLocalName() == element_07) {System.out.println("Discount: " + reader.getAttributeValue(1));}
			}
		}
	}
}