...
public class SAX_Parser extends DefaultHandler {
	...
	public static void main(String[] args) throws Exception {
		...
		final String element_06 = "price"; // added
		final String element_07 = "addon"; //added
		final String attribute_01 = "count";
		final String attribute_02 = "discount"; //added
		...
		DefaultHandler h = new DefaultHandler() {
			...
			String attribute_discount = null;
			...
			public void startElement(String a, String b, String c, Attributes d) throws SAXException {
				...
				if (c.equalsIgnoreCase(element_04)) {handler_06 = true;}
				if (c.equalsIgnoreCase(element_05)) {handler_05 = true; attribute_count = d.getValue(attribute_01);}
				if (c.equalsIgnoreCase(element_07)) {handler_07 = true; attribute_discount = d.getValue(attribute_02);}
			}
			...
			public void characters(char ch[], int start, int length) throws SAXException {
				...
				if (handler_06) {System.out.println("Price:\t " + new String(ch, start, length)); handler_06 = false;}
				if (handler_05) {System.out.println("Number of deals: " + attribute_count); handler_05 = false;}
				if (handler_07) {System.out.println("Discount: " + attribute_discount); handler_07 = false;}
			}
		};
		p.parse(url, h);
	}
